...
## Running DADA2
# View the output of demultiplexing (demux.qzv) using QIIME2 view to determine where to trim and truncate sequences for forward and reverse reads. 
# In this case, we used the consensus method of Chimera removal and used –p-n-threads 0 to use all available cores. 
# See here for more information on the DADA2 plugin and here for the paper associated with DADA2
...
# For our taxonomic analysis, we used the SILVA 132 release. Download the taxonomy.txt and .fna file and import into QIIME 2 artifacts.
...
# The scikit-learn version (0.19.1) used to generate this artifact does not match the current version of scikit-learn installed (0.21.2). 
# Please retrain your classifier for your current deployment to prevent data-corruption errors.
